...
public class MoveChara {
	...
	if (mapData.getMap(posX+dx, posY+dy) == MapData.TYPE_WALL){
	    return false;
	} else if (mapData.getMap(posX+dx, posY+dy) == MapData.TYPE_NONE || mapData.getMap(posX+dx, posY+dy) == MapData.TYPE_GOAL ){
	    return true;
	}
	
	/*add*/
	else if (mapData.getMap(posX+dx, posY+dy) == MapData.TYPE_KEYS){
